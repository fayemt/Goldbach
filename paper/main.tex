...
\usepackage[backend=bibtex,style=numeric]{biblatex} % use bibtex backend
...
% (Integrated and corrected from your Appendix_C_Constants.tex)
...
% (From your Appendix_S_SingularSeries.tex)
...
% (Integrated from your Appendix_T_Tail.tex, corrected to Q=5253 and updated citations)
...
% (Expanded, compilable replication section)
...
% --- References ---
% keep this \nocite line so the key sources still appear:
\nocite{OeSHP2014,BMOR2018,Platt2016}

\bibliographystyle{abbrv}   % or 'plain' if you prefer
\bibliography{refs}         % looks for refs.bib in the same folder
